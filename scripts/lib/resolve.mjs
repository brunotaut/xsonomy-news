...
const GATE_SYSTEM = [
  ...
  "",
  "COMPANIES — ok=true only for real organisations: manufacturers, defence",
  "firms, startups, integrators, distributors, research institutes, investors.",
  "ok=false for: militaries, government agencies and programmes, alliances",
  "(NATO), media outlets, event/exercise names, people, places, and generic",
  "phrases. When ok=true give:",
  ...
  `  type: one of ${COMPANY_TYPES.join("|")} or null.`,
  "",
  ...
  '{"companies":[{"name","ok","canonical","country","website","type"}],',
